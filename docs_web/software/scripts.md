...
3. Capture observations in [Troubleshooting Hub](troubleshooting/README.md) and update this catalog when scripts change.
...
- **`scripts/setup_webrtc_test.sh`** — Generates `.env.webrtc_test` for the [WebRTC Direct Test](networking/webrtc_direct_test.md).
